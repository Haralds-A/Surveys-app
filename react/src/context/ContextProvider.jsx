...
const tmpSurveys = [
    {
      "id": 1,
      "image_url": "https:\/\/upload.wikimedia.org\/wikipedia\/commons\/b\/b2\/Bootstrap_logo.svg",
      "title": "Bootstrap",
    ...
    {
      "id": 3,
      "image_url": "https:\/\/upload.wikimedia.org\/wikipedia\/commons\/3\/3d\/LaravelLogo.png",
      "title": "Laravel 9",
      "slug": "laravel-9",
      "status": true,
...
export const ContextProviderr = ({children}) =>{
