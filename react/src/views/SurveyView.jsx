                ...
                <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                    <div>
                        ...
                        <div className="mt-1 flex items-center">
                            ...
                            {!survey.image_url && (
                                <span className="flex justify-center itmes-center text-gray-400 h-12 w-12
                                 overflow-hidden rounded-full bg-gray-100">
                                    <PhotoIcon className="w-11 h-11"/>
                                </span>
                            )}
                            <button type="button"
                    ...
                    {/*Expire date*/}
                    <div className="col-span-6 sm:ccol-span-3">
                    ...
                    <div className="flex items-start">
                        <div className="flex h-5 items-center">
                            ...
                            onChange={(ev) => setSurvey({...survey, status: ev.target.value})}
                            />
                        </div>
